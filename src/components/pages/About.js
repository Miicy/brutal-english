...
function About() {
	...
	useEffect(() => {
		dispatch(getPagetext(PAGE_NAMES.about)).then((response) => {
	...
	const AboutPageBreadcrumbsContainerStyles = {
		height: "4%",
		width: "100%",
	};
	return (
		<div style={AboutPageContainer}>
			<div style={AboutPageBreadcrumbsContainerStyles}>
				<div style={{ marginLeft: "20px" }}>
					<Breadcrumbs aria-label="breadcrumb">
						...
						<p style={{ color: "black", fontWeight: "bold" }}>O nama</p>
					</Breadcrumbs>
				</div>
			</div>
			<div
			...
			<div
				style={{
					...
					height: isAdmin ? "fit-content" : "fit-content",
				}}
			>
				{isAdminLoggedIn ? (
					<div
