...
function Delivery() {
	...
	useEffect(() => {
		dispatch(getPagetext(PAGE_NAMES.DELIVERY)).then((response) => {
	...
	const DeliveryBreadcrumbsContainerStyles = {
		height: "4%",
		width: "100%",
	};
	return (
		<div style={DeliveryPageContainer}>
			<div style={DeliveryBreadcrumbsContainerStyles}>
				<div style={{ marginLeft: "20px" }}>
					<Breadcrumbs aria-label="breadcrumb">
						...
						<p style={{ color: "black", fontWeight: "bold" }}>Delivery</p>
					</Breadcrumbs>
				</div>
			</div>
			<div
